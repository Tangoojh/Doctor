...
<body>
	<form action="<c:url value="/doctor/add"/>" method="post" class="definewidth m20">
		<table class="table table-bordered table-hover definewidth m10">
			...
			<tr>
				...
				<td><select name="certificateType"><option value="1">身份证</option>
						<option value="2">护照</option>
						<option value="3">军人</option></select></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><select name="sectionId"><option value="1">血液科</option>
			...
			<tr>
				...
				<td><select name="education"><option value="1">本科</option>
						<option value="2">专科</option>
						<option value="3">研究生</option>
						<option value="4">博士生</option></select></td>
			</tr>
			<tr>
